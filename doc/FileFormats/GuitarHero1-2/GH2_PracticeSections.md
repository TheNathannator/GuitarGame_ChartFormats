...
Here is a list of practice mode section names, along with the in-game names they get converted to, from Guitar Hero 2. (Sourced from a list included with Feedback Editor)
