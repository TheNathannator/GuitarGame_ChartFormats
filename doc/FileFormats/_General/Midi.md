...
- `[mix <difficulty> drums<configuration><flag>]` - Sets a stem configuration for drums. This event may be found without brackets in some cases, and possibly with underscores instead of spaces.
