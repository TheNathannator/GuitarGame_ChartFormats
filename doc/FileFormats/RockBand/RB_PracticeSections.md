...
This is a *gargantuan* list of practice mode section names found in Rock Band and RBN2 charts, along with the in-game names they get converted to. Largely sourced from a [C3/RBN Docs page](http://docs.c3universe.com/rbndocs/index.php?title=All_Practice_Sections).

This document is likely missing section names, research needs to be done.
...
- `aco_gtr_intro` - (Not documented yet) 
