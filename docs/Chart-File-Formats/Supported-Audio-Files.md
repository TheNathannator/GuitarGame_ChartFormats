...
The file names listed in the following table are reserved for specific purposes.
...
The file names above can potentially use any possible audio format, but in practice only a specific set of formats is in wide usage. The formats in the table below are recommended to be supported, along with some comments regarding its usage:
